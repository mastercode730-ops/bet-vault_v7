    ...
    <>
      ...
      <aside className="sidebar hidden lg:flex flex-col fixed left-0 top-0 bottom-0 w-[240px] z-40 py-7 px-5">
        <button
          ...
          className="flex items-center gap-2.5 mb-8 focus:outline-none"
        >
          <Image
            src="/logo.jpeg"
            alt="Bet Vault"
            ...
            priority
          />
          <span className="serif font-semibold text-base gold-text">
            Bet Vault
          </span>
        </button>
        ...
        <p
          className="mono text-[10px] mt-3 text-center"
        ...
        <div className="flex items-center justify-between px-4 h-16">
          ...
          >
            <Image
              ...
              priority
            />
            <span className="serif font-semibold text-sm gold-text">
              Bet Vault
            </span>
          </button>
          <button
        ...
        <div className="lg:hidden fixed inset-0 z-[60] flex flex-col justify-end">
          ...
          <div className="sheet-panel relative rounded-t-3xl px-6 pt-5 pb-8 max-h-[80vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-between mb-5">
              <span
                className="serif font-semibold text-base"
                style={{ color: "var(--ink)" }}
              >
                Around the site
              </span>
            ...
            <div className="flex flex-col gap-0.5 mb-6">
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={() => setSheetOpen(false)}
                className="text-left px-3 py-3 rounded-lg text-sm font-medium focus:outline-none block"
                style={{
                  color: "var(--ink)",
                  borderBottom: "1px solid var(--line)",
                }}
